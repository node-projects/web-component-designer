...
import { AbstractExtension, handlesPointerEvent, IExtensionManager, IDesignerCanvas, IDesignItem, TextTool, OverlayLayer, ExtensionType } from "@node-projects/web-component-designer";
