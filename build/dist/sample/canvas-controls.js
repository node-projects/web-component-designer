...
import { UndoItemType } from "../elements/services/undoService/UndoItemType.js";
let CanvasControls = class CanvasControls extends PolymerElement {
  ...
  delete() {
    ...
    if (this._isCanvasElement(el)) {
      this.actionHistory.add(UndoItemType.Delete, el, {
  ...
  clone() {
    ...
    this.actionHistory.add(UndoItemType.New, clone, {
