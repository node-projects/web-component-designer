...
export class TabHandle {
  ...
  generateMoveTabEvent(event, pos) {
    ...
    if (m < this.moveThreshold && contain) this.moveTabEvent(this, event.state);
  }
  ...
  onCloseButtonClicked(e) {
    if (e.button !== 2) {
      ...
      if (this.parent.container.containerType === 'panel') {
        let panel = this.parent.container;
        panel.close(); // this.undockInitiator.enabled = false;
        // let panel = this.parent.container;
        // panel.performUndock();
      }
    }
  ...
  setSelected(isSelected) {
    ...
    if (isSelected) this.elementBase.classList.add(selectedClassName);else this.elementBase.classList.remove(selectedClassName);
  }
